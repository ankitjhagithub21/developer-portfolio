  ...
  return (
    <section className='row my-5 flex-wrap-reverse' id='about'>
      <div className="col-md-8 d-flex flex-column justify-content-center" data-aos="fade-right">
        ...
        <p className='fs-5'>Hi, I'm Ankit Jha, a passionate and detail-oriented full-stack developer with a strong foundation in front-end and back-end technologies. I enjoy creating interactive and user-friendly web applications.</p>
